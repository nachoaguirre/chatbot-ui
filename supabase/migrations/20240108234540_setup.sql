...
AS $$
DECLARE
  project_url TEXT := 'https://fmckrrnhxzkfuryanaqf.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZtY2tycm5oeHprZnVyeWFuYXFmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3OTc0ODYxMiwiZXhwIjoyMDk1MzI0NjEyfQ.RAz1P7uhgsCSDsWiJkTkIfkaShV8WmgX3gLvvqKYCXs'; -- full access needed for http request to storage
